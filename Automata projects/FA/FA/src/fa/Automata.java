...
public class Automata {
    ...
    /**
     * Variables that contain the Data about the machine
     */
    ...
    public Automata(int noOfState, char[] inputCharacter, int[][] transitionOfState, int initialState, int[] finalState) {
     ...
     * @return 
     */
    private boolean verifyFinalState(int state){
     ...
     */
    private int transition(int state,char currentCharacter){
     ...
     */
    private int getIndex(char givenCharacter){
        int i=0;
